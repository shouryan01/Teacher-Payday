...
__name2(findPrismaClientDir, "findPrismaClientDir");
...
`;
      ...
      if (process.platform === "win32" && isYarnUsed(baseDir)) {
        const hasCli = /* @__PURE__ */ __name2((s) => prismaCliDir !== void 0 ? s : "", "hasCli");
        const missingCli = /* @__PURE__ */ __name2((s) => prismaCliDir === void 0 ? s : "", "missingCli");
...
__name2(getAddPackageCommandName, "getAddPackageCommandName");
...
__name2(installPackage, "installPackage");
...
__name2(checkYarnVersion, "checkYarnVersion");
...
__name2(checkTypeScriptVersion, "checkTypeScriptVersion");
...
__name2(parseUserAgentString, "parseUserAgentString");
