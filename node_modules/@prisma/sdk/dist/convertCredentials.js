...
__name2(credentialsToUri, "credentialsToUri");
function uriToCredentials(connectionString) {
  ...
  const exists = /* @__PURE__ */ __name2((str) => str && str.length > 0, "exists");
  const extraFields = {};
...
__name2(uriToCredentials, "uriToCredentials");
...
__name2(databaseTypeToProtocol, "databaseTypeToProtocol");
...
__name2(protocolToConnectorType, "protocolToConnectorType");
