...
const debug = (0, debug_1.default)('cleanupCache');
const del = (0, util_2.promisify)(rimraf_1.default);
const readdir = (0, util_2.promisify)(fs_1.default.readdir);
const stat = (0, util_2.promisify)(fs_1.default.stat);
async function cleanupCache(n = 5) {
    try {
        const rootCacheDir = await (0, util_1.getRootCacheDir)();
        if (!rootCacheDir) {
