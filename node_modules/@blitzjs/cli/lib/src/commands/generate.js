...
const getIsTypeScript = () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    return require("fs").existsSync(require("path").join(yield require("next/dist/server/lib/utils").getProjectRoot(process.cwd()), "tsconfig.json"));
});
var ResourceType;
...
function modelName(input = "") {
    return (0, generator_1.singleCamel)(input);
}
function modelNames(input = "") {
    return (0, generator_1.pluralCamel)(input);
}
function ModelName(input = "") {
    return (0, generator_1.singlePascal)(input);
}
function ModelNames(input = "") {
    return (0, generator_1.pluralPascal)(input);
}
const generatorMap = {
    [ResourceType.All]: [
    ...
    handleNoContext(message) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (!shouldCreateNewRoot) {
                (0, logging_1.baseLogger)({ displayDateTime: false }).error("Could not determine proper location for files. Aborting.");
                this.exit(0);
            }
        });
    }
            ...
            try {
                ...
                for (const GeneratorClass of generators) {
                    const generator = new GeneratorClass({
                        ...
                        ParentModel: ModelName(flags.parent),
                        ParentModels: ModelNames(flags.parent),
                        name: (0, generator_1.uncapitalize)(model),
                        Name: (0, generator_1.capitalize)(model),
                ...
                if (err instanceof prompt_aborted_1.PromptAbortedError)
                    this.exit(0);
                (0, logging_1.baseLogger)({ displayDateTime: false }).error(err);
                this.exit(1);
            }
        });
    }
