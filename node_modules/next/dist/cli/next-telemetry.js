...
const nextTelemetry = (argv)=>{
    ...
    if (args['--enable'] || args._[0] === 'enable') {
        ...
        if (isEnabled) {
            console.log(_chalk.default.cyan('Your preference has been saved.'));
        } else {
            console.log(_chalk.default.yellow(`Blitz.js' telemetry collection is already disabled.`));
        }
        console.log();
        isEnabled = false;
    } else {
        console.log(_chalk.default.bold('Blitz.js Telemetry'));
        console.log();
    }
    console.log(`Status: ${isEnabled ? _chalk.default.bold.green('Enabled') : _chalk.default.bold.red('Disabled')}`);
    console.log();
    if (isEnabled) {
        console.log(`Blitz.js telemetry is completely anonymous. Thank you for participating!`);
    } else {
