...
var _router = _interopRequireWildcard(require("../shared/lib/router/router"));
...
function useRouterQuery() {
    ...
    const query = _react.default.useMemo(()=>(0, _router).extractQueryFromAsPath(router.asPath)
    , [
        router.asPath, 
    ]);
    return query;
...
function useParams(returnType) {
    ...
    const params = _react.default.useMemo(()=>{
        const rawParams = (0, _router).extractRouterParams(router.query, query);
