...
export declare const topLevelFoldersThatMayContainPages: string[];
export declare function convertPageFilePathToRoutePath(filePath: string, pageExtensions: string[]): string;
export declare function convertPageFilePathToResolverName(filePathFromAppRoot: string): string;
export declare function convertPageFilePathToResolverType(filePathFromAppRoot: string): "query" | "mutation";
export declare function getIsPageFile(filePathFromAppRoot: string): boolean;
export declare function getIsRpcFile(filePathFromAppRoot: string): boolean;
export declare function buildPageExtensionRegex(pageExtensions: string[]): RegExp;
