            ...
            ExportDefaultDeclaration (path) {
                ...
                switch(def.type){
                    case 'ArrowFunctionExpression':
                        {
                            if (!process.env.__NEXT_TEST_MODE || !!process.env.__NEXT_TEST_ANON_EXPORT) {
                                warn([
                    ...
                    case 'FunctionDeclaration':
                        {
                            ...
                            if (isAnonymous && (!process.env.__NEXT_TEST_MODE || !!process.env.__NEXT_TEST_ANON_EXPORT)) {
                                warn([
