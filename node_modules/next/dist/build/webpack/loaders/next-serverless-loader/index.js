...
const nextServerlessLoader = function() {
    ...
    return loaderSpan.traceFn(()=>{
        const { distDir , absolutePagePath , page , pagesDir: rawPagesDir , buildId , canonicalBase , assetPrefix , absoluteAppPath , absoluteDocumentPath , absoluteErrorPath , absolute404Path , generateEtags , poweredByHeader , basePath , runtimeConfig , previewProps , loadedEnvFiles , i18n ,  } = typeof this.query === 'string' ? (0, _querystring).parse(this.query.substr(1)) : this.query;
        const pagesDir = (0, _normalizePagePath).normalizePathSep(rawPagesDir);
        const sessionCookiePrefix = (0, _utils1).getSessionCookiePrefix((0, _configShared).loadConfigProduction(pagesDir));
        const setEnvCode = `
