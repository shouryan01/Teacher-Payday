...
function isIgnoredPlugin(pluginPath) {
    ...
    console.warn(`${_chalk.default.yellow.bold('Warning')}: Please remove the ${_chalk.default.underline(plugin)} plugin from your PostCSS configuration. ` + `This plugin is automatically configured by Blitz.js.\n` + 'Read more: https://nextjs.org/docs/messages/postcss-ignored-plugin');
    return true;
}
