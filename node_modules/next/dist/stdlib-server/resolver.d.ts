import { AuthenticatedSessionContext, Ctx, SessionContextBase } from 'next/types';
...
declare function zod<Schema extends ZodTypeAny, InputType = zInput<Schema>, OutputType = zOutput<Schema>>(schema: Schema, parserType: 'sync'): (input: InputType) => OutputType;
declare function zod<Schema extends ZodTypeAny, InputType = zInput<Schema>, OutputType = zOutput<Schema>>(schema: Schema, parserType: 'async'): (input: InputType) => Promise<OutputType>;
declare function zod<Schema extends ZodTypeAny, InputType = zInput<Schema>, OutputType = zOutput<Schema>>(schema: Schema): (input: InputType) => Promise<OutputType>;
