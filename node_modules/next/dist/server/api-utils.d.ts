...
import { PreviewData } from '../types/index';
import { NextApiRequest, NextApiResponse, Middleware } from '../shared/lib/utils';
...
export declare type ApiResolverCtx = {
    route: string;
    config: NextConfig;
};
export declare function apiResolver(req: IncomingMessage, res: ServerResponse, query: any, resolverModule: any, apiContext: __ApiPreviewProps, propagateError: boolean, { route, config: blitzConfig }: ApiResolverCtx): Promise<void>;
export declare type RpcHandlerCtx = {
    route: string;
};
export declare type Resolver<TInput, TResult> = (input: TInput, ctx?: any) => Promise<TResult>;
export declare function getRpcMiddleware(resolver: Resolver<any, any>, { route }: RpcHandlerCtx): Middleware;
/**
