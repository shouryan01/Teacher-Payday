...
var _blitzAppRoot = require("../stdlib/blitz-app-root");
...
class ServerRouter {
    constructor(pathname, query, as, { isFallback  }, isReady, basePath, locale, locales, defaultLocale, domainLocales, isPreview, isLocaleDomain){
        ...
        this.query = query;
        this.params = (0, _router).extractRouterParams(query, (0, _router).extractQueryFromAsPath(as));
        this.asPath = as;
...
function normalizeRedirectValues(router, redirect) {
    const dest = redirect.destination;
    if (dest && typeof dest === 'object') {
        const resolvedDest = (0, _router).resolveHref(router, dest, true);
...
async function renderToHTML(req, res, pathname1, query1, renderOpts) {
    ...
    } , Component , buildManifest , fontManifest , reactLoadableManifest , ErrorDebug , getStaticProps , getStaticPaths , getServerSideProps , isDataReq , params , previewProps , basePath: basePath1 , devOnlyCacheBusterQueryString , concurrentFeatures ,  } = renderOpts;
    ...
    const ctx = {
        ...
        AppTree: (props)=>{
            return(/*#__PURE__*/ _react.default.createElement(AppContainer, {
                appProps: {
                    ...props,
                    Component,
                    router
    ...
    const AppContainer = ({ children , appProps  })=>/*#__PURE__*/ _react.default.createElement(_blitzAppRoot.BlitzWrapper, {
            appProps: appProps
    ...
    try {
        ...
        if (isSSG && !isFallback1) {
            ...
            if ('redirect' in data && data.redirect && typeof data.redirect === 'object') {
                normalizeRedirectValues(router, data.redirect);
    ...
    if (!isSSG && !getServerSideProps && process.env.NODE_ENV !== 'production' && Object.keys((props === null || props === void 0 ? void 0 : props.pageProps) || {
        ...
        console.warn(`The prop \`url\` is a reserved prop in Blitz.js for legacy reasons and will be overridden on page ${pathname1}\n` + `See more info here: https://nextjs.org/docs/messages/reserved-page-prop`);
    }
    // Avoid rendering page un-necessarily for getServerSideProps data request
    // and getServerSideProps/getStaticProps redirects
    if (isDataReq && !isSSG || renderOpts.isRedirect) {
        if (props) {
            props.superjsonProps = (0, _superjson).serialize(props.pageProps);
        }
    ...
    const renderToString = concurrentFeatures ? (element)=>new Promise((resolve, reject)=>{
    ...
    const renderPage = (options = {
        ...
        const htmlOrPromise = renderToString(/*#__PURE__*/ _react.default.createElement(AppContainer, {
            appProps: {
                Component: EnhancedComponent,
                router,
                ...props
            }
        }, /*#__PURE__*/ _react.default.createElement(EnhancedApp, Object.assign({
            Component: EnhancedComponent,
            router: router
        }, props))));
        return typeof htmlOrPromise === 'string' ? {
