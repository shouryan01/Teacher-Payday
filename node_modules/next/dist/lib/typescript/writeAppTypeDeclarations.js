...
async function writeAppTypeDeclarations(baseDir, imageImportsEnabled) {
    ...
    const appTypeDeclarations = _path.default.join(baseDir, 'blitz-env.d.ts');
    await _fs.promises.writeFile(appTypeDeclarations, '/// <reference types="next" />' + _os.default.EOL + '/// <reference types="next/types/global" />' + _os.default.EOL + (imageImportsEnabled ? '/// <reference types="next/image-types/global" />' + _os.default.EOL : '') + _os.default.EOL + '// NOTE: This file should not be edited' + _os.default.EOL + '// see https://nextjs.org/docs/basic-features/typescript for more information.' + _os.default.EOL);
}
