...
export declare function normalizeApiRoute(path: string): string;
/**
...
export declare function extractQueryFromAsPath(asPath: string): Record<string, string | string[]>;
export declare function extractRouterParams(routerQuery: ParsedUrlQuery, asPathQuery: ParsedUrlQuery): Dictionary<T>;
export {};
