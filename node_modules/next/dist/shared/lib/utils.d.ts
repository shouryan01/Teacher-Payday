...
export declare type BlitzComponentType<C extends BaseContext = NextPageContext, IP = {}, P = {}> = NextComponentType<C, IP, P>;
...
export declare type IsAuthorizedArgs = Session extends {
...
export declare function getIsRpcRoute(routePath: string): boolean;
