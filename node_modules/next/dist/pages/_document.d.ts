 ...
 */
export declare class Document<P = {}> extends Component<DocumentProps & P> {
    /**
...
export declare class DocumentHead extends Head {
}
...
export declare class BlitzScript extends NextScript {
}
