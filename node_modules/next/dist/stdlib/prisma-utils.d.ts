...
export declare const enhancePrisma: <TPrismaClientCtor extends Constructor<unknown>>(client: TPrismaClientCtor) => EnhancedPrismaClientConstructor<TPrismaClientCtor>;
export {};
