...
class Telemetry {
    constructor({ distDir  }){
        this.notify = ()=>{
            ...
            console.log(`${_chalk.default.magenta.bold('Attention')}: Blitz.js now collects completely anonymous telemetry regarding usage.`);
            console.log(`This information is used to shape Blitz.js' roadmap and prioritize features.`);
        ...
        this.submitRecord = (_events)=>{
            ...
            return (0, _postPayload)._postPayload({
                context,
                meta,
        ...
        const { NEXT_TELEMETRY_DISABLED , NEXT_TELEMETRY_DEBUG , BLITZ_TELEMETRY_DISABLED , BLITZ_TELEMETRY_DEBUG ,  } = process.env;
        this.NEXT_TELEMETRY_DISABLED = BLITZ_TELEMETRY_DISABLED || NEXT_TELEMETRY_DISABLED;
